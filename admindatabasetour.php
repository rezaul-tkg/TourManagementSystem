...
<div class="main">
  ...
  <div style="background-color:#E1E0D5">
		<center><h1><b style="color:#000000">Administration Database Panel</b></h1></center>
         <center> <caption><b style='color:#000000; font-size:25px'>Tour Management List</b></caption></center><br/>
		  <center><table> 
				  <tr> 
					<td valign="top">
				...
				echo "<tr><th style='color:#000000; font-size:13px'><b>Tour Code</b></th><th style='color:#000000; font-size:13px'><b>User Name</b></th><th style='color:#000000; font-size:13px'><b>Name</b></th><th style='color:#000000; font-size:13px'><b>Address</b></th><th style='color:#000000; font-size:13px'><b>Phone No</b></th><th style='color:#000000; 	font-size:13px'><b>Email Address</b></th><th style='color:#000000; 	font-size:13px'><b>Destination</b></th><th style='color:#000000; font-size:13px'><b>Start Date</b></th><th style='color:#000000; font-size:13px'><b>End Date</b></th><th style='color:#000000; font-size:13px'><b>Bugget TK</b></th><th style='color:#000000; font-size:13px'><b>Command	
				</b></th></tr>";
				
				while($row1 = mysql_fetch_row($result)){ 
						@print "<tr><td style='color:#000000; font-size:15px'>" . $row1[0] . "</td><td style='color:#000000; font-size:13px'>" . $row1[1] ."</td><td 
						style='color:#000000; font-size:13px'>".$row1[2]."</td><td style='color:#000000; font-size:13px'>" . $row1[3] ."</td><td style='color:#000000; 
						font-size:13px'>" . $row1[4] ."</td><td style='color:#000000; font-size:13px'>" . $row1[5] ."</td><td style='color:#000000; 
						font-size:13px'>" . $row1[6] ."</td><td style='color:#000000; font-size:13px'>" . $row1[7] ."</td><td style='color:#000000; font-size:13px'>" . $row1[8] . "</td><td style='color:#000000; font-size:13px'>" . 
						$row1[9] ."</td>"."<td name='commandTD'>  &nbsp;&nbsp;&nbsp;<form method='post' action=''><input type='submit' name='updateBTN' value='Update'>  
						&nbsp;&nbsp;&nbsp; <input type='submit' 
						name='deleteTourBTN' value='Delete'><input type='hidden' name='hiddenID' value='" . $row1[0] . "'></form>  &nbsp;&nbsp;&nbsp;
						</td></tr>"; 
					}						
